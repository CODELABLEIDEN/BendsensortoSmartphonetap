...
if __name__ == '__main__':
    ...
    checkpoint_filepath = 'MA_inverted_full.hd5'
    ...
    with open('MA_inverted_full.json', 'w') as json_file:
        json_file.write(json_model)
    #saving the weights of the model
    model.save_weights('MA_inverted_full_weights.h5')
